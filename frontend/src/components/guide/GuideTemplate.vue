  ...
  >
    ...
    >
      <div class="flex w-full items-center justify-between">
        ...
        >
        <span
          class="rounded-full bg-primary/10 px-2.5 py-0.5 text-xs font-medium tracking-[0.2em] text-primary uppercase"
        >
          {{ locale }}
        </span>
      </div>
      ...
      <div class="flex flex-col items-center gap-5 text-center">
        ...
        <p class="max-w-md text-base leading-relaxed text-ink">
    ...
    >
      ...
      <GuideFooter :page="PAGE_INTRO" :total-pages="TOTAL_PAGES" />
    </section>
    ...
    >
      ...
      >
        <template v-for="(entry, idx) in tocEntries" :key="entry.page">
          <div
            v-if="
              entry.group === 'mode1' && tocEntries[idx - 1]?.group !== 'mode1'
            "
      ...
      <GuideFooter :page="PAGE_TOC" :total-pages="TOTAL_PAGES" />
    </section>
    ...
    >
      ...
      >
        ...
        <ul class="mt-1 grid max-w-md grid-cols-2 gap-x-6 gap-y-1 text-left">
          <li
            v-for="entry in mode1TocEntries"
            :key="entry.page"
      ...
      <GuideFooter :page="PAGE_MODE1_DIVIDER" :total-pages="TOTAL_PAGES" />
    </section>
    ...
    >
      ...
      <GuideFooter :page="PAGE_MODE1_IMPORT" :total-pages="TOTAL_PAGES" />
    </section>
    ...
    >
      ...
      <GuideFooter :page="PAGE_MODE1_CONTROLS" :total-pages="TOTAL_PAGES" />
    </section>
    ...
    >
      ...
      <div class="mt-3 rounded-xl border border-border bg-muted/30 px-4 py-2.5">
        <p class="text-sm leading-relaxed text-justify text-ink">
          {{ t("guide.steps.filters.note") }}
        </p>
      </div>

      <GuideFooter :page="PAGE_MODE1_FILTERS" :total-pages="TOTAL_PAGES" />
    </section>
    ...
    >
      ...
      <GuideFooter :page="PAGE_MODE1_READING" :total-pages="TOTAL_PAGES" />
    </section>
    ...
    >
      ...
      <GuideFooter :page="PAGE_MODE1_COMPARE" :total-pages="TOTAL_PAGES" />
    </section>
    ...
    >
      ...
      <GuideFooter :page="PAGE_MODE1_DATATABLE" :total-pages="TOTAL_PAGES" />
    </section>
    ...
    >
      ...
      <GuideFooter :page="PAGE_MODE1_ADDPOINT1" :total-pages="TOTAL_PAGES" />
    </section>
    ...
    >
      ...
      <GuideFooter :page="PAGE_MODE1_ADDPOINT2" :total-pages="TOTAL_PAGES" />
    </section>
    ...
    >
      ...
      <GuideFooter :page="PAGE_MODE1_ADDPOINT3" :total-pages="TOTAL_PAGES" />
    </section>
    ...
    >
      ...
      <GuideFooter :page="PAGE_MODE1_ANNOTATE" :total-pages="TOTAL_PAGES" />
    </section>
    ...
    >
      ...
      <GuideFooter :page="PAGE_MODE1_COMPARE_PINS" :total-pages="TOTAL_PAGES" />
    </section>
    ...
    >
      ...
      <GuideFooter :page="PAGE_MODE1_EXPORT_CHART" :total-pages="TOTAL_PAGES" />
    </section>
    ...
    >
      ...
      <GuideFooter :page="PAGE_MODE1_EXPORT_PIN" :total-pages="TOTAL_PAGES" />
    </section>
    ...
    >
      ...
      >
        ...
        <div
          class="flex max-w-md items-center gap-3 rounded-xl border border-border bg-muted/20 px-4 py-2.5 text-left"
        >
          <Info class="size-5 shrink-0 text-primary" />
          <p class="text-xs leading-snug text-ink">
            <strong class="font-semibold"
              >{{ t("guide.mode2.status.title") }}.</strong
            >
        ...
        <div class="mt-1 flex items-center justify-center gap-2.5">
          <div class="flex flex-col items-center gap-1">
            ...
            <span class="text-[10px] text-secondary">{{
              t("guide.mode2.divider.flow.upload")
            }}</span>
          </div>
          ...
          <div class="flex flex-col items-center gap-1">
            ...
            <span class="text-[10px] text-secondary">{{
              t("guide.mode2.divider.flow.extract")
            }}</span>
          </div>
          <ArrowRight class="size-3.5 shrink-0 text-secondary/40" />
          <div class="flex flex-col items-center gap-1">
            <span
              class="flex size-9 items-center justify-center rounded-lg bg-secondary/10 text-secondary"
            >
              <ClipboardCheck class="size-4" />
            </span>
            <span class="text-[10px] text-secondary">{{
              t("guide.mode2.divider.flow.review")
            }}</span>
          </div>
        </div>
        <p class="text-[10px] text-secondary/70 italic">
          {{ t("guide.mode2.divider.caption") }}
        </p>
      </div>
      <GuideFooter :page="PAGE_MODE2_DIVIDER" :total-pages="TOTAL_PAGES" />
    </section>
    ...
    >
      ...
      <div>
        <h3 class="mb-1 text-sm font-semibold text-primary">
          {{ t("guide.mode2.today.title") }}
        </h3>
        <p class="mb-2 text-[11.5px] leading-snug text-ink">
          {{ t("guide.mode2.today.body") }}
        </p>
        <div
          class="flex items-center justify-center gap-3 rounded-xl border border-border bg-muted/20 px-4 py-3"
        >
          <div class="flex flex-col items-center gap-1">
            <span
              class="flex size-9 items-center justify-center rounded-lg bg-primary/10 text-primary"
            ...
            <span class="text-[10px] text-secondary">{{
              t("guide.mode2.today.flow.upload")
            }}</span>
          </div>
          <ArrowRight class="size-3.5 shrink-0 text-secondary/40" />
          <div class="flex flex-col items-center gap-1">
            ...
            <span class="text-[10px] text-secondary">{{
              t("guide.mode2.today.flow.model")
            }}</span>
          </div>
          <ArrowRight class="size-3.5 shrink-0 text-secondary/40" />
          <div class="flex flex-col items-center gap-1">
            ...
            <span class="text-[10px] text-secondary">{{
              t("guide.mode2.today.flow.progress")
            }}</span>
          </div>
          <ArrowRight class="size-3.5 shrink-0 text-secondary/40" />
          <div class="flex flex-col items-center gap-1">
            ...
            <span class="text-[10px] text-secondary">{{
              t("guide.mode2.today.flow.export")
            }}</span>
          </div>
        </div>
      </div>
      ...
      <div class="mt-3">
        <h3 class="mb-1 text-sm font-semibold">
          {{ t("guide.mode2.preview.title") }}
        </h3>
        <p class="mb-2 text-[11px] leading-snug text-secondary">
          {{ t("guide.mode2.preview.intro") }}
        </p>
        <div class="grid grid-cols-3 gap-2.5">
          <div class="rounded-lg border border-border bg-muted/30 px-3 py-2">
            <p
              class="mb-1 flex items-center gap-1.5 text-xs font-semibold text-ink"
            >
              <Sparkles class="size-3.5 shrink-0 text-primary" />{{
                t("guide.mode2.preview.rules.title")
              }}
            </p>
            <ul
              class="flex flex-col gap-1 pl-3.5 text-[11px] leading-snug text-secondary"
            >
              <li class="list-disc">
                {{ t("guide.mode2.preview.rules.items.scope") }}
              </li>
              <li class="list-disc">
                {{ t("guide.mode2.preview.rules.items.vocab") }}
              </li>
              <li class="list-disc">
                {{ t("guide.mode2.preview.rules.items.periodic") }}
              </li>
            </ul>
          </div>
          <div class="rounded-lg border border-border bg-muted/30 px-3 py-2">
            <p
              class="mb-1 flex items-center gap-1.5 text-xs font-semibold text-ink"
            >
              <Table2 class="size-3.5 shrink-0 text-primary" />{{
                t("guide.mode2.preview.columns.title")
              }}
            </p>
            <p class="text-[11px] leading-snug text-secondary">
              {{ t("guide.mode2.preview.columns.body") }}
            </p>
          </div>
          <div class="rounded-lg border border-border bg-muted/30 px-3 py-2">
            <p
              class="mb-1 flex items-center gap-1.5 text-xs font-semibold text-ink"
            >
              <ClipboardCheck class="size-3.5 shrink-0 text-primary" />{{
                t("guide.mode2.preview.validation.title")
              }}
            </p>
            <p class="text-[11px] leading-snug text-secondary">
              {{ t("guide.mode2.preview.validation.body") }}
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="mt-3">
        <div class="mb-1.5 flex items-center gap-2">
          <h3 class="text-sm font-semibold">
            {{ t("guide.mode2.wireframe.title") }}
          </h3>
          <span
            class="rounded-full bg-amber-500/15 px-2 py-0.5 text-[10px] font-semibold tracking-wide text-amber-700 uppercase"
          >
            {{ t("guide.mode2.wireframe.badge") }}
          </span>
        </div>
        <p class="mb-2 text-[11px] leading-snug text-secondary">
          {{ t("guide.mode2.wireframe.caption") }}
        </p>
        ...
        <div
          class="flex overflow-hidden rounded-xl border border-dashed border-border"
        >
          <div
            class="flex-1 border-r border-dashed border-border bg-muted/20 p-4"
          >
            ...
            <div
              class="mb-2 h-9 w-full rounded-md border border-dashed border-primary/50 bg-primary/8"
            />
            <div class="mb-1.5 h-2 w-full rounded-full bg-secondary/15" />
          ...
          <div class="flex-1 bg-white p-4">
            ...
            >
              ...
              <div
                class="h-4.5 flex-1 rounded-md border border-secondary/20 bg-muted/20"
              />
            </div>
      ...
      <GuideFooter :page="PAGE_MODE2" :total-pages="TOTAL_PAGES" />
    </section>
    ...
    >
      <div class="flex-1" />
      <div
        class="mx-auto flex max-w-md flex-col items-center gap-4 text-center"
      >
        <div class="h-px w-16 bg-border" />
        <p
          class="text-xs font-semibold tracking-[0.3em] text-secondary uppercase"
        >
          {{ t("guide.about.eyebrow") }}
        </p>
        <p class="text-sm leading-relaxed text-ink">
          {{ t("guide.about.body") }}
        </p>
        <p class="text-sm leading-relaxed text-ink">
          {{ t("guide.about.supervision") }}
        </p>
        <div class="h-px w-16 bg-border" />
      </div>
      <div class="flex-1" />
      <p class="self-end text-sm text-secondary italic">
        {{ t("guide.about.signoff") }}
      </p>
    </section>
...
const addPointFieldLabel = (field: Parameters<typeof addPointFieldLabelWithT>[0]) =>
...
const mode1DividerOutlineTitle = computed(
  () => `${t("guide.mode1.eyebrow")} — ${t("guide.mode1.title")}`,
);
...
async function captureGuideArtifacts() {
  ...
  if (addPoint1Wrap.value) {
    ...
    push(
      addPoint1Marks,
      addPointLabelWrap.value ? markRect(c, addPointLabelWrap.value, 4) : null,
    );
    push(
      addPoint1Marks,
      addPointAxesWrap.value ? markRect(c, addPointAxesWrap.value, 4) : null,
    );
    push(
      addPoint1Marks,
      addPointDomainOriginWrap.value
        ? markRect(c, addPointDomainOriginWrap.value, 4)
        : null,
    );
    push(
      addPoint1Marks,
      addPointShapeWrap.value ? markRect(c, addPointShapeWrap.value, 4) : null,
    );
    push(
      addPoint1Marks,
      addPointMetricsWrap.value
        ? markRect(c, addPointMetricsWrap.value, 4)
        : null,
    );
    push(
      addPoint1Marks,
      addPointQFactorWrap.value
        ? markRect(c, addPointQFactorWrap.value, 4)
        : null,
    );
  }
  ...
  if (addPoint2Wrap.value) {
    ...
    push(
      addPoint2Marks,
      addPointNode1Wrap.value ? markRect(c, addPointNode1Wrap.value, 4) : null,
    );
    push(
      addPoint2Marks,
      addPointNode2Wrap.value ? markRect(c, addPointNode2Wrap.value, 4) : null,
    );
    push(
      addPoint2Marks,
      addPointNode3Wrap.value ? markRect(c, addPointNode3Wrap.value, 4) : null,
    );
  }
  ...
  if (comparePinsTopWrap.value) {
    const c = comparePinsTopWrap.value;
    push(
      comparePinsTopMarks,
      markUnion(
        c,
        [comparePinsChipsRowWrap.value, comparePinsSortRowWrap.value],
        4,
      ),
    );
  }
  ...
  if (markupBlockWrap.value) {
    ...
    push(
      comparePinsMarks,
      markupToolsWrap.value ? markRect(c, markupToolsWrap.value, 4) : null,
    );
  ...
  pinExportDataUrl.value =
    annotationsPanelRef.value?.getExportDataUrl(DEMO_PIN_ID_R3_EXP) ?? null;
  metricsExportDataUrl.value =
    annotationsPanelRef.value?.getMetricsExportDataUrl(DEMO_PIN_ID_R3_EXP) ?? null;
  // Page 10's "Compare (2)" figure -- see AnnotationsPanel's exposed getComparePngDataUrl.
  comparePngUrl.value =
    annotationsPanelRef.value?.getComparePngDataUrl([
      DEMO_PIN_ID_R3_EXP,
      DEMO_PIN_ID_R1_SIM,
    ]) ?? null;
